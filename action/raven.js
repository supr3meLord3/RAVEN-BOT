...
const { menu, menulink, antidel, antitag, appname, herokuapi, gptdm, botname, antibot, author, packname, mycode, admin, botAdmin, dev, group, bad, owner, NotOwner, antilinkall, badwordkick } = require("../set.js");
